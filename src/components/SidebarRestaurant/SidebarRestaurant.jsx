...
const SidebarRestaurant = ({
  ...
  const [showPaymentsbyRestaurant, setShowPaymentsbyRestaurant] = useState(false);
  ...
  return (
    <div className='sidebarRestaurant'>
      <hr />
      <div className="sidebar-options">
        ...
        <div className="sidebar-option">
          <button onClick={handlePaymentsbyRestaurantClick}>Payments</button>
        </div>
      </div>
